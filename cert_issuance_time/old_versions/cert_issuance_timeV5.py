...
def extract_user_logs(log_file):
    ...
    num_certificados = 0
    tempos_emissao = defaultdict(list)  # Armazena os tempos de emissão de cada certificado
    ...
    return user_logs, num_certificados, tempo_minimo, tempo_maximo, tempo_medio
...
def main():
    ...
    user_logs, num_certificados, tempo_minimo, tempo_maximo, tempo_medio = extract_user_logs(args.input_file)
